...
import { EntityArrayResponseType, PlantService } from '../service/plant.service';
...
export class PlantComponent implements OnInit {
  ...
  trackId = (_index: number, item: IPlant): number => this.plantService.getPlantIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.plants = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IPlant[] | null): IPlant[] {
    return data ?? [];
  }
  ...
  protected queryBackend(
    ...
    return this.plantService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
